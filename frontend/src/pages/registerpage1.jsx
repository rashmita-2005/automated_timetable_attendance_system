      ...
      <div className="bg-white shadow-md rounded-lg p-8 max-w-md w-full">
        ...
        <form>
          <div className="mb-4">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="fullName" type="text" placeholder="John Doe" required />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-6">
            ...
            <select id="role" className="shadow border rounded w-full py-2 px-3 text-gray-700">
              <option value="student">Student</option>
              <option value="faculty">Faculty</option>
            </select>
          </div>
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full" type="submit">Register</button>
        </form>
